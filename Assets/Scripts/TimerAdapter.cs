...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>Context-groep-3/Assets/Scripts/TimerAdapter.cs at master · TiddoLangerak/Context-groep-3</title>
...
<meta content="cPRq7ztbntjHoVrZBIfbaNmAzZxwfzYMjMY7YQCUsC4=" name="csrf-token" />
    ...
    <link href="https://a248.e.akamai.net/assets.github.com/assets/github2-5de3d46f6ab432b35b7a03b6cb0bd08529fd8661.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="62054cb04ed0972ba467ddd3ca77ccfc">
        ...
        <link data-pjax-transient rel='permalink' href='/TiddoLangerak/Context-groep-3/blob/c6374c672b743c18470a891391197389b22ee9ea/Assets/Scripts/TimerAdapter.cs'>
        ...
        <div class="select-menu-modal">
          ...
          <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket css-truncate" data-tab-filter="branches">
            ...
            <div data-filterable-for="commitish-filter-field" data-filterable-type="substring">
                ...
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/TiddoLangerak/Context-groep-3/blob/arch-refactor-2/Assets/Scripts/TimerAdapter.cs" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="arch-refactor-2" rel="nofollow" title="arch-refactor-2">arch-refactor-2</a>
                </div> <!-- /.select-menu-item -->
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/TiddoLangerak/Context-groep-3/blob/decouple-kinect/Assets/Scripts/TimerAdapter.cs" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="decouple-kinect" rel="nofollow" title="decouple-kinect">decouple-kinect</a>
                </div> <!-- /.select-menu-item -->
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/TiddoLangerak/Context-groep-3/blob/demo/Assets/Scripts/TimerAdapter.cs" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="demo" rel="nofollow" title="demo">demo</a>
                </div> <!-- /.select-menu-item -->
                <div class="select-menu-item js-navigation-item selected">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/TiddoLangerak/Context-groep-3/blob/master/Assets/Scripts/TimerAdapter.cs" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="master" rel="nofollow" title="master">master</a>
                </div> <!-- /.select-menu-item -->
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/TiddoLangerak/Context-groep-3/blob/timer/Assets/Scripts/TimerAdapter.cs" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="timer" rel="nofollow" title="timer">timer</a>
                </div> <!-- /.select-menu-item -->
            </div>
              ...
              <form accept-charset="UTF-8" action="/TiddoLangerak/Context-groep-3/branches" class="js-create-branch select-menu-item select-menu-new-item-form js-navigation-item js-new-item-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="cPRq7ztbntjHoVrZBIfbaNmAzZxwfzYMjMY7YQCUsC4=" /></div>
                ...
                <input type="hidden" name="path" id="branch" value="Assets/Scripts/TimerAdapter.cs" />
...
<!-- blob contrib key: blob_contributors:v21:661f83e06fe1ebbefea71d8eded2a9c3 -->
<!-- blob contrib frag key: views10/v8/blob_contributors:v21:661f83e06fe1ebbefea71d8eded2a9c3 -->
...
<div id="slider">
    ...
    <div class="frames">
      <div class="frame" data-permalink-url="/TiddoLangerak/Context-groep-3/blob/c6374c672b743c18470a891391197389b22ee9ea/Assets/Scripts/TimerAdapter.cs" data-title="Context-groep-3/Assets/Scripts/TimerAdapter.cs at master · TiddoLangerak/Context-groep-3 · GitHub" data-type="blob">
            ...
            <div class="meta">
              ...
              <div class="actions">
                <div class="button-group">
                        <a class="minibutton"
                           href="/TiddoLangerak/Context-groep-3/edit/master/Assets/Scripts/TimerAdapter.cs"
                           data-method="post" rel="nofollow" data-hotkey="e">Edit</a>
                  <a href="/TiddoLangerak/Context-groep-3/raw/master/Assets/Scripts/TimerAdapter.cs" class="button minibutton " id="raw-url">Raw</a>
                    <a href="/TiddoLangerak/Context-groep-3/blame/master/Assets/Scripts/TimerAdapter.cs" class="button minibutton ">Blame</a>
                  <a href="/TiddoLangerak/Context-groep-3/commits/master/Assets/Scripts/TimerAdapter.cs" class="button minibutton " rel="nofollow">History</a>
                </div><!-- /.button-group -->
              </div><!-- /.actions -->
...
<span id="L6" rel="#L6">6</span>
          ...
          <td class="blob-line-code">
                  <div class="highlight"><pre><div class='line' id='LC1'><span class="k">using</span> <span class="nn">System</span><span class="p">;</span></div><div class='line' id='LC2'><span class="k">using</span> <span class="nn">System.Timers</span><span class="p">;</span></div><div class='line' id='LC3'><br/></div><div class='line' id='LC4'><span class="k">public</span> <span class="k">class</span> <span class="nc">TimerAdapter</span> <span class="p">:</span> <span class="n">Timer</span><span class="p">,</span> <span class="n">ITimer</span></div><div class='line' id='LC5'><span class="p">{</span></div><div class='line' id='LC6'><span class="p">}</span></div></pre></div>
          </td>
        </tr>
      </table>
  </div>
...
<div id="js-frame-loading-template" class="frame frame-loading large-loading-area" style="display:none;">
  ...
  <div class="container clearfix">
    ...
    <p class="right">&copy; 2013 <span title="0.12023s from fe19.rs.github.com">GitHub</span>, Inc. All rights reserved.</p>
  ...
  <div class="fullscreen-sidebar">
    ...
    <span id='server_response_time' data-time='0.12078' data-host='fe19'></span>
